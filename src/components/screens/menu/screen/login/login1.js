...
import { scaleModerate, scaleVertical } from '@kittenDesign/scale';
...
export class LoginV1 extends React.Component {
  ...
  getThemeImageSource = (theme) => (
    theme.name === 'light' ?
      require('../../../../../../assets/images/config/backgroundLoginV1.png') : require('../../../../../../assets/images/config/backgroundLoginV1DarkTheme.png')
  );
